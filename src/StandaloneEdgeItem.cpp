...
StandaloneEdgeItem::StandaloneEdgeItem(BaseVertexItem *start, BaseVertexItem *end, QGraphicsItem *parent)
...
BaseEdgeConstraint *StandaloneEdgeItem::getConstraint() const { return nullptr; }
